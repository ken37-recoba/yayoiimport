// =================================================================================
// ファイル名: Gemini.js (UFJ通帳の読取り精度向上版)
...
`;
    ...
    // ▼▼▼【改善箇所】UFJ銀行のルールをより具体的に指示 ▼▼▼
    let bankSpecificInstructions = '';
    if (bankType === 'MUFG') {
        bankSpecificInstructions = `
# 三菱UFJ銀行の特別ルール
- **列の定義:** 三菱UFJ銀行の通帳は、「摘要」のすぐ右隣の列が「お支払金額（出金）」、そのさらに右隣の列が「お預り金額（入金）」です。この物理的な位置関係を絶対に守って、数値をそれぞれの項目に割り当ててください。
